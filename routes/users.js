                ...
                if (err) {
                    ...
                    for (let i = 0; i < result.length; i++) {
                        tableDiv.innerHTML +=
                            ...
                            result[i].email +
                            '</td><td class=\'edit-column text-center\'><a class="text-dark" href="/user/profile/' + result[i].name + '"><i class="fa-solid fa-pen-to-square  "></i></a></td></tr>' +
                            ...
                            result[i].email +
                            '</td></tr><tr><th id="mini-edit" class="p-2" scope="col">Edit</th><td class=\'mini-edit-column\'><a class="text-dark" href="/user/profile/' + result[i].name + '"><i class="fa-solid fa-pen-to-square"></i></a></td></tr></table></td></tr>';
                    }
