				...
				if (err) {
					...
					for (let i = 0; i < result.length; i++) {
						tableDiv.innerHTML +=
							...
							result[i].email +
							'</td><td class=\'edit-column text-center\'><a class="text-dark" href="#"><i class="fa-solid fa-pen-to-square  "></i></a></td></tr>' +
							'<tr id="info"><td colspan=2><table id="nested-table-'+ (i + 1) + '"class="nested mx-2"><tr><th id="mini-email" class="p-2" scope="col">Email</th><td class=\'mini-email-column px-1\'>' +
							result[i].email +
							'</td></tr><tr><th id="mini-edit" class="p-2" scope="col">Edit</th><td class=\'mini-edit-column\'><a class="text-dark" href="#"><i class="fa-solid fa-pen-to-square"></i></a></td></tr></table></td></tr>';
					}
		...
		if (err) {
			...
			for (let i = 0; i < result.length; i++) {
				tableDiv +=
					...
					"</td><td>" +
					result[i].email +
					'</td><td><a class="text-dark" href=""><i class="fa-solid fa-pen-to-square  "></i></a></td></tr>';
			}
			if (tableDiv == "") {
				res.send("no results");
			} else {
